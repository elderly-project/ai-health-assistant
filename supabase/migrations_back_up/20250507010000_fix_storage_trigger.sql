-- Make the storage upload trigger more robust with error handling

-- Create a more robust version of the handle_storage_update function with better error handling
