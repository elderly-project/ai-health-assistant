...
-- allows to identify if something is a uuid or not
...
-- the lines below are for RLS (row level security)
-- applies the autorization logic directly on the table
-- since it is a low level, it is more secure
